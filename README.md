...
[https://www.t4d.io/developintelligence-react-03102021](https://www.t4d.io/developintelligence-react-03102021)
...
```
git clone https://github.com/t4d-classes/react_03102021.git FOLDER_NAME
```
...
5. To verify the REST API is working, run the `npm start` command and browse the following URL: [http://localhost:3050/cars](http://localhost:3050/cars).
